...
/**
 * A source filter that reads from given file. The implementation is the same as 
 * the {@link SourceFilter}. 
 */
public class SourceFilterFileReader extends FilterFramework {
  private String filename;

  public SourceFilterFileReader(String argFilename) {
